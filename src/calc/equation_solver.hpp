...
namespace calc {
    ...
    public:
        ...
        virtual void find_particular_solution(std::shared_ptr<calc::Solution> general_solution, const double& initial_x, const double& initial_x_prime) = 0;
    };
    ...
    public:
        ...
        void find_particular_solution(std::shared_ptr<calc::Solution> general_solution, const double& initial_x, const double& initial_x_prime) override;
    };
