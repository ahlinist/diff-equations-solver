...
namespace calc {
    ...
    public:
        ...
        virtual std::shared_ptr<calc::Solution> find_particular_solution(std::shared_ptr<calc::Solution> solution, const double& initial_x, const double& initial_x_prime) = 0;
    };
    ...
    public:
        ...
        std::shared_ptr<calc::Solution> find_particular_solution(std::shared_ptr<calc::Solution> solution, const double& initial_x, const double& initial_x_prime) override;
    };
