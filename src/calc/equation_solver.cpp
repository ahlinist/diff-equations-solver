...
std::shared_ptr<calc::Solution> calc::UnderDampedEquationSolver::solve(
    ...
    long double coefficient_a = initial_y;
    long double coefficient_b = (initial_y_prime - roots_real_part * initial_y) * first_root_imaginary_part;
...
std::shared_ptr<calc::Solution> calc::OverDampedEquationSolver::solve(
    ...
    long double coefficient_b = (initial_y_prime - first_root_real_part * initial_y)/(second_root_real_part - first_root_real_part);
    long double coefficient_a = initial_y - coefficient_b;
...
std::shared_ptr<calc::Solution> calc::CriticallyDampedEquationSolver::solve(
    ...
    long double coefficient_a = initial_y;
    long double coefficient_b = initial_y_prime - roots_real_part;
