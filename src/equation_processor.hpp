...
public:
    explicit EquationProcessor(const input::InputParser& input_parser, const input::InputFormatter& input_formatter, const calc::EquationSolverFactory& equation_solver_factory);
    void process();
};
