...
INSTANTIATE_TEST_CASE_P(
        ...
        ::testing::Values(
                std::make_tuple("x = cos(t)", calc::UnderDampedSolution{{0, 1}, {0, -1}, 1, 0}),
                std::make_tuple("x = e^(11t)*(9cos(7t)+13sin(7t))", calc::UnderDampedSolution{{11, 7}, {11, -7}, 9, 13}),
                std::make_tuple("x = e^(-2t)*-3cos(7t)", calc::UnderDampedSolution{{-2, 7}, {-2, -7}, -3, 0}),
                std::make_tuple("x = e^(-2t)*5cos(2t)", calc::UnderDampedSolution{{-2, 2}, {-2, -2}, 5, 0}),
                std::make_tuple("x = e^(2t)*5sin(2t)", calc::UnderDampedSolution{{2, 2}, {2, -2}, 0, 5}),
                std::make_tuple("x = e^(-t)*(-cos(t)-sin(t))", calc::UnderDampedSolution{{-1, 1}, {-1, -1}, -1, -1}),
                std::make_tuple("x = e^(t)*(cos(-t)+sin(-t))", calc::UnderDampedSolution{{1, -1}, {1, 1}, 1, 1})));
...
INSTANTIATE_TEST_CASE_P(
        ...
        ::testing::Values(
                std::make_tuple("x = -6e^(-2t)-8e^(-3t)", calc::OverDampedSolution{{-2, 0}, {-3, 0}, -6, -8}),
                std::make_tuple("x = 5e^(3.14t)", calc::OverDampedSolution{{2, 0}, {3.14, 0}, 0, 5}),
                std::make_tuple("x = -e^(-t)-1", calc::OverDampedSolution{{-1, 0}, {0, 0}, -1, -1}),
                std::make_tuple("x = 3e^(t)+4e^(-t)", calc::OverDampedSolution{{1, 0}, {-1, 0}, 3, 4})));
...
INSTANTIATE_TEST_CASE_P(
        ...
        ::testing::Values(
                std::make_tuple("x = (11+15t)*e^(1.2t)", calc::CriticallyDampedSolution{{1.2, 0}, {1.2, 0}, 11, 15}),
                std::make_tuple("x = (-6-8t)*e^(-2t)", calc::CriticallyDampedSolution{{-2, 0}, {-2, 0}, -6, -8}),
                std::make_tuple("x = 5t", calc::CriticallyDampedSolution{{0, 0}, {0, 0}, 0, 5}),
                std::make_tuple("x = (-1-t)*e^(-t)", calc::CriticallyDampedSolution{{-1, 0}, {-1, 0}, -1, -1}),
                std::make_tuple("x = t*e^(t)", calc::CriticallyDampedSolution{{1, 0}, {1, 0}, 0, 1})));
