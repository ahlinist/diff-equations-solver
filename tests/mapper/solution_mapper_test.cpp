...
TEST(SolutionMapperTestSuite, ShouldSerializeUnderDampedSolution) {
    ...
    std::string expected = "{\"initialEquation\":\"initial equation\",\"max_at_t\":1.0,\"resultEquation\":\"x = (cos(t)+sin(t))\",\"solution\":{\"addend\":{\"argument\":1.0,\"coefficient\":1.0,\"type\":\"sin\"},\"augend\":{\"argument\":1.0,\"coefficient\":1.0,\"type\":\"cos\"},\"multiplier\":{\"argument\":0.0,\"coefficient\":1.0,\"type\":\"e\"}}}";
    mapper::SolutionMapperImpl mapper{};
...
TEST(SolutionMapperTestSuite, ShouldSerializeOverDampedSolution) {
    ...
    std::string expected = "{\"initialEquation\":\"initial equation\",\"max_at_t\":1.0,\"resultEquation\":\"x = e^(-2t)+1e^(-3t)\",\"solution\":{\"addend\":{\"argument\":-3.0,\"coefficient\":1.0,\"type\":\"e\"},\"augend\":{\"argument\":-2.0,\"coefficient\":1.0,\"type\":\"e\"},\"multiplier\":{\"argument\":0.0,\"coefficient\":1.0,\"type\":\"e\"}}}";
    mapper::SolutionMapperImpl mapper{};
...
TEST(SolutionMapperTestSuite, ShouldSerializeCriticallyDampedSolution) {
    ...
    std::string expected = "{\"initialEquation\":\"initial equation\",\"max_at_t\":1.0,\"resultEquation\":\"x = (1+t)*e^(-2t)\",\"solution\":{\"addend\":{\"argument\":1.0,\"coefficient\":1.0,\"type\":\"t\"},\"augend\":{\"argument\":0.0,\"coefficient\":1.0,\"type\":\"e\"},\"multiplier\":{\"argument\":-2.0,\"coefficient\":1.0,\"type\":\"e\"}}}";
    mapper::SolutionMapperImpl mapper{};
