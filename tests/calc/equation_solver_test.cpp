...
TEST(EquationSolverTestSuite, ShouldReturnPointerToCriticallyDampedSolution) {
    ...
    calc::CriticallyDampedSolution expected = calc::CriticallyDampedSolution{{-1, 0}, {-1, 0}, 1, 3, initial_equation, result_equation, 0.6666666666666666};
...
TEST(EquationSolverTestSuite, ShouldReturnPointerToUnderDampedGeneralSolution) {
    ...
    std::string initial_equation = "initial equation";
    std::string result_equation = "result equation";
    calc::UnderDampedSolution expected = calc::UnderDampedSolution{{-0.5, 0.5}, {-0.5, -0.5}, 1, 0.25, initial_equation, result_equation, 5.202346306638418};
...
TEST(EquationSolverTestSuite, ShouldReturnPointerToOverDampedGeneralSolution) {
    ...
    std::string initial_equation = "initial equation";
    std::string result_equation = "result equation";
    calc::OverDampedSolution expected = calc::OverDampedSolution{{-2, 0}, {-0.5, 0}, -4, 6, initial_equation, result_equation, 0.6538861686744841};
